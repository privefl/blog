...
- This should be free.
- This should be easy.
- This should only need RStudio and GitHub.
- __Every content should be previewable from RStudio.__
...
I chose to use the [Jekyll Now template](https://github.com/barryclark/jekyll-now). I extended it so that posts have a similar rendering as an [HTML Pretty Document](http://statr.me/2016/08/creating-pretty-documents-with-the-prettydoc-package/) with theme "cayman" and highlight "github". I also created a function called `FormatPost` to convert an R Markdown document in your future post.
...
- when you are happy with the result, you use `FormatPost`,
