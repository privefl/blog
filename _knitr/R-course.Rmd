...
5. For the last chapter, we covered [how to make an R package](https://privefl.github.io/advr38book/packages.html). I show them that it was really easy and fast, mainly thanks to packages {usethis} and {roxygen2}. We had time to cover the full documentation, testing, automatic checking of packages and even how to make a website of a package.
...
Using a [Slack poll](https://simplepoll.rocks/), we agreed to [learn Shiny](https://privefl.github.io/advr38book/shiny.html). For this, I used [this nice and free Data Camp course](https://www.datacamp.com/courses/building-web-applications-in-r-with-shiny). 
