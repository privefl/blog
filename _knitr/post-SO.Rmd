...
In this post, I will give some insights about answering questions on Stack Overflow for a month.
...
- **purrr** is badly received as a proxy of base R functions like `sapply` or `lapply` (https://stackoverflow.com/questions/45101045/why-use-purrrmap-instead-of-lapply)
...
- Guiding to a solution is much more fun than just giving it (https://stackoverflow.com/questions/45308904/how-can-i-make-a-list-of-data-frames-which-have-the-same-values-in-the-first-col). Yet, I don't think it's the philosophy of SO. 

## Conclusion and bonuses

I think it was a good experience to answer questions on SO for a month. Yet, I'm getting tired of it for many reasons. I'm proud of [this algorithm written only with dplyr] (https://stackoverflow.com/a/45302898/6103040) that automatically get you a combination of variables of the dataset to form a [unique key](https://en.wikipedia.org/wiki/Unique_key). Also, I wanted to make a blog post about good practices for parallelization in R. I'm not sure how to do and which format to use, but you can get [some good practices in one of my answer](https://stackoverflow.com/a/45196081/6103040). Finally, if you miss the previous infinite printing of tibble, you can get a workaround [there](https://stackoverflow.com/a/44868837/6103040).
