...
date: "November 21, 2018" # DO NOT USE Sys.Date()
...
We have seen that `hclust()` was performing better than `kmeans()` (for this example). Then, we have seen how to determine the number of clusters. Finally, we have seen that using a particular statistic, specifically designed for this problem, improved the solution.

Of course, this could be improved a lot. For example, this won't work for plots having a background color or some grid inside. Feel free to bring your ideas.
