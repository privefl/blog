...
The data is in a PDF [there](https://goo.gl/wUXvjk). I'm not an expert in scraping and parsing data but this was actually very simple due to well-formatted dataset. 
