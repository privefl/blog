...
Here, the vectorized function is much faster than the two others and the for-loop approach is faster than the `sapply` equivalent when just-in-time compilation is enabled. (Edit: for some unknown reason, this result is true only in interactive mode? Try the code yourself!)
