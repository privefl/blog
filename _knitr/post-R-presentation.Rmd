...
As I was writing my R Markdown presentation while they were answering the google form, I decided that I should get (and show) the results automatically (only by re-knitting my presentation).
...
I would like to show them how many package we had on CRAN, so I used:
```{r, eval=FALSE}
...
You can see the presentation [there](privefl.github.io/R-presentation/pResentation.html) and the corresponding Rmd file [there](privefl.github.io/R-presentation/pResentation.Rmd).
