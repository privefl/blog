...
With one small example, we have seen several statistics to compute some degree of outlierness, and several ways to decide the threshold of being an outlier according to those statistics.
